  ...
  return (
    <div className="min-h-screen flex items-center justify-center" aria-busy="true" aria-label="Loading page">
      <div className="flex flex-col items-center gap-4">
        ...
        {/* shimmer bar — no inline background so the CSS .skeleton animation runs */}
        <div className="rounded-full overflow-hidden skeleton" style={{ width: 120, height: 2 }} />
      </div>
    </div>
  );
}
...
function App() {
  // Arm the Zeus thunder engine — plays a single welcome clap on first user gesture.
  useEffect(() => { initSound(); }, []);
